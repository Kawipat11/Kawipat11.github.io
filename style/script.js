...
const educationBx_label = document.getElementsByClassName('education_label');


for (i = 0; i < educationBx.length; i++) {
    educationBx[i].addEventListener('click', function () {
        this.classList.toggle('active')
    })
}
/*
var educationBx = document.querySelector('.educationBx');
    educationBx.addEventListener('click',function(){
        educationBx.classList.toggle('active')
    })*/
...
function scrollFunction() {
  if (document.body.scrollTop > 1 || document.documentElement.scrollTop > 1) {
    document.getElementById("scroll_top").setAttribute("class","wrapper2");
  } else {
    document.getElementById("scroll_top").setAttribute("class","wrapper");
  }
}

//**card flip */

const card = document.querySelector(".experience_card");
